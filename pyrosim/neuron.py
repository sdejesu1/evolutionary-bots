...
class NEURON: 
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, presynapseWeight, presynapseValue):
        syn_weight_by_val = presynapseWeight * presynapseValue
        self.Add_To_Value(syn_weight_by_val)
